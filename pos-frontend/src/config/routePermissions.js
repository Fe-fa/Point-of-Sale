...
export const ROUTE_PERMISSIONS = {
  ...
  '/admin/manager':        'page.manager_dashboard',  
...
export const SIDEBAR_NAV = [
  // ── Main ────────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { label: 'Manager',        path: '/admin/manager',    permission: 'page.manager_dashboard',      icon: 'BarChart2',    roles: ['manager'] },
    ],
  },
  ...
  // ── Catalog ──────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      { label: 'GRN',            path: '/admin/grn',        permission: 'page.grn',            icon: 'PackagePlus' },
    ],
  },
